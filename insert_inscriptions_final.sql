-- Script SQL final optimisé pour Supabase (PostgreSQL)
...
SELECT 
  nouvelle_inscription.id, 'BADET', 'Vincent', DATE '1985-03-15', 1
FROM nouvelle_inscription
UNION ALL
SELECT 
  nouvelle_inscription.id, 'BADET', 'Lucas', DATE '2014-05-20', 2
FROM nouvelle_inscription
UNION ALL
SELECT 
  nouvelle_inscription.id, 'BADET', 'Raphael', DATE '2018-08-10', 3
FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'BOURDIN', 'Stéphanie', DATE '1982-09-12', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'SCARDINA', 'Sébastien', DATE '1980-04-25', 2 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'SCARDINA', 'Adrien', DATE '2008-03-18', 3 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'SCARDINA', 'Gabriel', DATE '2015-07-22', 4 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'AYEL', 'François', DATE '1978-11-30', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'AYEL', 'Martin', DATE '2010-06-14', 2 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'FOURNIER', 'Pascal', DATE '1975-02-28', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'SEVREZ', 'Sara', DATE '1983-12-05', 2 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'FOURNIER', 'Mael', DATE '2015-04-10', 3 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'BARBIER', 'Julie', '1985-07-18', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'CHALANT BARBIER', 'Tom', '2016-03-25', 2 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'CHALANT BARBIER', 'Loïs', '2020-01-15', 3 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'BRETECHER', 'Mickaël', '1982-01-20', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'BRETECHER', 'Léandre', '2012-09-08', 2 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'UGNON-FLEURY', 'Xavier', '1975-08-14', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'UGNON-FLEURY', 'Clément', '2008-04-22', 2 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'BADET', 'Vincent', '1985-03-15', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'BADET', 'Lucas', '2014-05-20', 2 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'BADET', 'Raphael', '2018-08-10', 3 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'JEANGUYOT', 'Pierre', '1978-03-10', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'JEANGUYOT', 'Louis', '2011-12-15', 2 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'MARIELLE', 'Camille', '2008-02-28', 1 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'PANZUTI', 'Laura', '1990-06-12', 1 FROM nouvelle_inscription;
...
INSERT INTO participants_weekend_vtt (inscription_id, nom, prenom, date_naissance, ordre_participant)
SELECT nouvelle_inscription.id, 'SÉNÉCHAL', 'Romain', '1987-11-05', 1 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'SÉNÉCHAL', 'Arthur', '2017-01-20', 2 FROM nouvelle_inscription
UNION ALL
SELECT nouvelle_inscription.id, 'SÉNÉCHAL', 'Maya', '2022-05-30', 3 FROM nouvelle_inscription;
